        ...
        <Element name="about" className="about" onClick={actionMenu}>
            ...
            <div className="about__content content">
                ...
                <div className="content__buttons">
                    <Button label="a" to="https://blog.jesusmarzor.com">{t('blog')}</Button>
                    <Button label="download" download="CV-Jesus-Martin" to={(i18n.language === LANGUAGES.ES) ? CV_ES : CV_EN} inverse={true}>{t('download_cv')}</Button>
                </div>
            </div>
        </Element>
    )
